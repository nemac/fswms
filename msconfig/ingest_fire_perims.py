...
def query_builder(): #(start_date, end_date):
  url = "https://services3.arcgis.com/T4QMspbfLg3qTGWY/arcgis/rest/services/CY_WildlandFire_Perimeters_ToDate/FeatureServer/0/query?outFields=*&outSR=4326&f=pgeojson&orderByFields=GISAcres+DESC&where=1%3D1"
  print(url)
  return url
